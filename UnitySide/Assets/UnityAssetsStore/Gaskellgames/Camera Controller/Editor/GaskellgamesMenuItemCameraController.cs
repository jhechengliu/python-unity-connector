...
namespace Gaskellgames.CameraController
{
    public class GaskellgamesMenuItemCameraController : GaskellgamesMenuItem
    {
        ...
        private const string GaskellgamesGameObjectMenu_CameraController = GaskellgamesGameObjectMenu + "/Camera Controller";
        
        [MenuItem(GaskellgamesGameObjectMenu_CameraController + "/Camera Brain", false, 10)]
        ...
        [MenuItem(GaskellgamesGameObjectMenu_CameraController + "/Camera Rig", false, 25)]
        ...
        [MenuItem(GaskellgamesGameObjectMenu_CameraController + "/Camera Rig (Free Fly)", false, 25)]
        ...
        [MenuItem(GaskellgamesGameObjectMenu_CameraController + "/Camera Rig (Freelook)", false, 25)]
        ...
        [MenuItem(GaskellgamesGameObjectMenu_CameraController + "/Camera Track", false, 40)]
        ...
        [MenuItem(GaskellgamesGameObjectMenu_CameraController + "/Camera Dolly", false, 40)]
        ...
        [MenuItem(GaskellgamesGameObjectMenu_CameraController + "/Camera Shaker", false, 55)]
        ...
        [MenuItem(GaskellgamesGameObjectMenu_CameraController + "/Camera Trigger Zone", false, 55)]
        ...
        [MenuItem(GaskellgamesGameObjectMenu_CameraController + "/Camera Trigger Zone (Multi Target)", false, 55)]
